...
window.addEventListener('scroll', function(){
  const popular = document.querySelector('.about')
...
menu.addEventListener('click', function(){
    ...
    <div class="col">
      <div class="card">
        <div class="gambar">
          <img src="images/pizza_lain.jpeg">
        </div>
        <div class="text">
          <h1>Pizza</h1>
        <div class="star">
    ...
    <div class="col">
      <div class="card">
        <div class="gambar">
          <img src="images/belgium_waffles.jpeg">
        </div>
        <div class="text">
    ...
    <div class="col">
      <div class="card">
        <div class="gambar">
          <img src="images/cupcake_pork.jpeg">
        </div>
        <div class="text">
          <h1>Cupcake Pork</h1>
        <div class="star">
